...
<section id="packages" class="packages">
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-12 wow animated fadeInUp">
                <a class="btn packages_btn active" href="#packages_row1"><?php the_field('kvartyry', 'option'); ?></a>
            </div>
            <div class="col-md-4 col-12">
                <a class="btn packages_btn" href="#packages_row2"><?php the_field('budynky', 'option'); ?></a>
            </div>
            <div class="col-md-4 col-12 wow animated fadeInUp">
                <a class="btn packages_btn" href="#packages_row3"><?php the_field('biznes', 'option'); ?></a>
            </div>
        </div>
