    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-7 col-12 info_pos">
                <h2 class="h2 info_title wow animated fadeInLeft"><?php the_field('i_title'); ?></h2>
                <p class="info_subtitle wow animated fadeInLeft"><?php the_field('i_text'); ?></p>
            ...
            <div class="col-lg-5 col-12">
                <div class="info_form wow animated fadeInRight">
